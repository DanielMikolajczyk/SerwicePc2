<div class="text-white">
  ...
  <div>
    <ul class="space-y-2">
      ...
      <li class="hover:bg-gray-700 pl-8 py-1"><a href="{{route('ordertype.index')}}" class="block">Rodzaje zamówień</a></li>
      ...
      <li class="hover:bg-gray-700 pl-8 py-1"><a href="" class="block">Wyloguj</a></li>
    </ul>
  </div>
</div>