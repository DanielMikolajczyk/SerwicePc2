...
@section('content')
  <div class="py-8 mt-4 max-w-7xl mx-auto sm:px-6 lg:px-8">
    <span class="font-medium text-2xl">Edycja Typu Zamówienia</span>
  </div>
  <x-forms.background>
      ...
      <div class="p-2">
        ...
        <div class="grid grid-cols-6 gap-4 mb-4 w-full">
          ...
          <div class="col-span-2">
            ...
            <x-forms.input name="name" :value="$orderType->name" :errors="$errors->messages()" />
          </div>

          <div class="col-span-6">
            <x-forms.label>Opis</x-forms.label>
            <x-forms.textarea name="description" :errors="$errors->messages()">{{ $orderType->description }}
            </x-forms.textarea>
          </div>
